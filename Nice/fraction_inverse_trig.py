...
def arcsin(box_code, box_dash):
    ...
    if power == 1:
        ...
        return [[f"{box_dash_v}arcsin{box_c}{box_v}{shift}{index}"], [f"(1 + {box_c}{box_v}{shift}^2)^1/2"], constant_product]
...
def arccos(box_code, box_dash):
    ...
    if power == 1:
        ...
        return [[f"{box_dash_v}arccos{box_c}{box_v}{shift}{index}"], [f"(1 + ({box_c}{box_v})^2)^1/2"], -constant_product]
